...
My core skills include designing and implementing machine learning systems that are subject to specified fairness and privacy constraints and are working with user data. As a side interest, I'm studying molecular biology and neuroscience and have completed some coursework in them.
